    ...
    if not df.empty:
        ...
        if 'transactionId' in df.columns:
            ...
            for tid, group_df in grouped:
                ...
                time_str = latest['timestamp'].strftime('%I:%M %p') if 'timestamp' in latest else 'N/A'
                ...
                with st.expander(header, expanded=is_active):
                    ...
                    for idx, update_row in group_df.iterrows():
                        update_time = update_row['timestamp'].strftime('%I:%M %p') if 'timestamp' in update_row else 'N/A'
