...
def home_view(df):
    ...
    with col1:
        ...
        case_trend = [d['transactionId'].nunique() if not d.empty and 'transactionId' in d.columns else 0 for d in trends]
        st.metric("Cases Today", cases)
        st.plotly_chart(create_mini_chart(case_trend), use_container_width=True, config={'displayModeBar': False})
    ...
    with col2:
        ...
        active_trend = [2, 1, 3, 2, 1, 2, active_cnt]
        st.plotly_chart(create_mini_chart(active_trend), use_container_width=True, config={'displayModeBar': False})
    ...
    with col3:
        ...
        st.plotly_chart(create_mini_chart([1, 2, 1, 3, 2, 1, ended]), use_container_width=True, config={'displayModeBar': False})
    ...
    with col4:
        ...
        st.plotly_chart(create_mini_chart([1, 1, 2, 1, 2, 1, over]), use_container_width=True, config={'displayModeBar': False})
