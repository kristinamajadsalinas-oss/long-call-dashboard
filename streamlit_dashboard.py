...
def home_view(df):
    ...
    # Layout (balanced proportions to match metrics row)
        ...
        with st.container(border=True):
            ...
            if not df.empty:
                ...
                if table_data:
                    ...
                    # Display table with arrow column
                    event = st.dataframe(
                        table_df,
                        ...
                        column_config={
                            ...
                            "→": st.column_config.TextColumn("View", width="small")
                        },
                        on_select="rerun",
                    ...
                    if event and event.selection and event.selection.rows:
                        ...
                        selected_engineer = table_df.iloc[selected_idx]['Engineer']
                        st.session_state.current_view = 'engineer'
                        st.session_state.selected_engineer = selected_engineer
                        st.rerun()
            else:
